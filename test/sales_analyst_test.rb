...
class SalesAnalystTest < Minitest::Test
  ...
  def test_merchants_with_pending_invoices
    #
     # p @sales_analyst.merchants_with_pending_invoices[0].class
     # p @sales_analyst.merchants_with_pending_invoices.count
     p @sales_analyst.invoices_not_paid.uniq.length
     p @sales_analyst.pending_ids.uniq.length
